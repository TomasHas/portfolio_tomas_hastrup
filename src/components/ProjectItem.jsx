...
const ProjectItem = ({ img, title, src, text, stack }) => {
  return (
    <div
      className={`  grid grid-cols-1 w-80 md:grid-cols-2 md:w-6/12   shadow-lg shadow-gray-400 overflow-hidden rounded-xl mx-auto transition-transform duration-500 hover:scale-110 `}
    >
      ...
      <div className=" flex flex-col justify-between  font-bold text-black text-center ">
        <div className="h-full flex items-center ">
          <div className="flex flex-col items-center mt-2  gap-3 h-10/12 w-full ">
