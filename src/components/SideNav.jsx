...
const SideNav = () => {
  ...
  const buttonStyle =
    "w-[75%] flex justify-center items-center rounded-full dark:bg-gray-900 dark:shadow-white dark:text-white shadow-lg shadow-white bg-white m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-100";
  return (
    <div>
      ...
      <div className=" md:block sm:block hidden fixed top-[20%] z-10">
        <div className=" flex flex-col ">
          <a
            href="#main"
            className="w-[75%] flex justify-center items-center rounded-full dark:bg-gray-900 dark:shadow-white dark:text-white shadow-lg shadow-white bg-white m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-100"
          >
            <AiOutlineHome size={20} />
          </a>
